...
int main()
{
	...
	cout << "output in Oct unsigned int type: " << oct << testUnint << endl;//⑧进制
	double num1 = 3.3, num2 = -2.3;
	cout << "int(3.3) = " << static_cast<int>(num1) << endl; 
	cout << "int(-2.3) = " << static_cast<int>(num2) << endl; 
	return 0;
}